...
Infos: https://www.blog.berrybase.de/blog/2020/11/09/neopixel-ring-mit-arduino-ansteuern-so-wirds-gemacht/#NeoPixel_Ring_mit_Arduino_ansteuern_Schritt_fuer_Schritt_erklaert
**************************************************************************************************
Version: 06.05.2021
**************************************************************************************************
Board: NANO
...
//colorWipe(strip.Color(0, 0, 0, 255), 50); // Weis RGBW
  // Senden Sie eine Theater-Pixel-Jagd in...
  theaterChase(strip.Color(127, 127, 127), 50); // Weis
...
// Etwas anders, macht dies den Regenbogen gleichmäßig verteilt in
